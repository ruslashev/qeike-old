...
const char *idParser::GetFileName( void ) const {
...
int idParser::GetFileOffset( void ) const {
  if ( idParser::scriptstack ) {
...
time_t idParser::GetFileTime( void ) const {
  if ( idParser::scriptstack ) {
...
int idParser::GetLineNum( void ) const {
  if ( idParser::scriptstack ) {
...
int idParser::ReadSourceToken( idToken *token ) {
  ...
  if ( !idParser::scriptstack ) {
    die( "idParser::ReadSourceToken: not loaded" );
    return false;
  }
  changedScript = 0;
...
int idParser::LoadFile( const char *filename, bool OSPath ) {
  ...
  if ( idParser::loaded ) {
    die("idParser::loadFile: another source already loaded");
    return false;
  }
...
int idParser::LoadMemory(const char *ptr, int length, const char *name ) {
  ...
  if ( idParser::loaded ) {
    die("idParser::loadMemory: another source already loaded");
    return false;
  }
